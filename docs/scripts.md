...
| [`fm-treehouse-lib.sh`](../bin/fm-treehouse-lib.sh) | Per-home Treehouse pool root, its version-floor capability probe, legacy repository-global slot reporting, and pool slot-owner claims |
